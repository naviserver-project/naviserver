...
NS_EXTERN Ns_LogSeverity Ns_LogAccessDebug; /* Severtity to control mirroring access log entries to sytem log */
...
NS_EXTERN Ns_DString*    Ns_ConnSockContent(const Ns_Conn *conn) NS_GNUC_NONNULL(1) NS_GNUC_PURE;
