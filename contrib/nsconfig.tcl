...
nsv_set _ns_config ns:enabled       [set enabled [ns_config -bool ns/server/nsconfig enabled 0]]
nsv_set _ns_config ns:url           [set url [ns_config ns/server/nsconfig url "/_nsconfig"]]
nsv_set _ns_config ns:user          [ns_config ns/server/nsconfig user "naviserver"]
nsv_set _ns_config ns:password      [ns_config ns/server/nsconfig password "admin"]
