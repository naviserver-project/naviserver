...
static const Cmd basicCmds[] = {
    ...
    {"ns_crypto::agreement",     NsTclCryptoAgreementObjCmd},
    {"ns_crypto::argon2",        NsTclCryptoArgon2ObjCmd},
    {"ns_crypto::eckey",         NsTclCryptoEckeyObjCmd},
    {"ns_crypto::hmac",          NsTclCryptoHmacObjCmd},
    {"ns_crypto::kem",           NsTclCryptoKemObjCmd},
    {"ns_crypto::key",           NsTclCryptoKeyObjCmd},
    ...
    {"ns_crypto::signature",     NsTclCryptoSignatureObjCmd},
    ...
    {"ns_percentdecode",         NsTclPercentDecodeObjCmd},
    {"ns_percentencode",         NsTclPercentEncodeObjCmd},
