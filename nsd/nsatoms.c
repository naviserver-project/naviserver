...
InitCoreAtomSpecs(void)
{
    ...
    atoms[NS_ATOM_1].name                = "1";              atoms[NS_ATOM_1].len       = 1;

    atoms[NS_ATOM_3].name                = "3";              atoms[NS_ATOM_3].len = 1;
    atoms[NS_ATOM_DASH_offset].name      = "-offset";        atoms[NS_ATOM_DASH_offset].len = 7;
    atoms[NS_ATOM_DASH_size].name        = "-size";          atoms[NS_ATOM_DASH_size].len = 5;
    atoms[NS_ATOM_ERROR].name            = "ERROR";          atoms[NS_ATOM_ERROR].len = 5;
    atoms[NS_ATOM_FILTER_RETURN].name    = "FILTER_RETURN";  atoms[NS_ATOM_FILTER_RETURN].len = 13;
    atoms[NS_ATOM_FORBIDDEN].name        = "FORBIDDEN";      atoms[NS_ATOM_FORBIDDEN].len = 9;
    atoms[NS_ATOM_IPv4].name             = "IPv4";           atoms[NS_ATOM_IPv4].len = 4;
    atoms[NS_ATOM_IPv6].name             = "IPv6";           atoms[NS_ATOM_IPv6].len = 4;
    atoms[NS_ATOM_OK].name               = "OK";             atoms[NS_ATOM_OK].len = 2;
    atoms[NS_ATOM_UNAUTHORIZED].name     = "UNAUTHORIZED";   atoms[NS_ATOM_UNAUTHORIZED].len = 12;
    atoms[NS_ATOM_absent].name           = "absent";         atoms[NS_ATOM_absent].len = 6;
    atoms[NS_ATOM_address].name          = "address";        atoms[NS_ATOM_address].len = 7;
    atoms[NS_ATOM_agreement].name        = "agreement";      atoms[NS_ATOM_agreement].len = 9;
    ...
    atoms[NS_ATOM_argon2].name           = "argon2";         atoms[NS_ATOM_argon2].len = 6;
    ...
    atoms[NS_ATOM_capabilities].name     = "capabilities";   atoms[NS_ATOM_capabilities].len = 12;
    ...
    atoms[NS_ATOM_crv].name              = "crv";            atoms[NS_ATOM_crv].len = 3;
    ...
    atoms[NS_ATOM_digest].name           = "digest";         atoms[NS_ATOM_digest].len = 6;
    atoms[NS_ATOM_digests].name          = "digests";        atoms[NS_ATOM_digests].len = 7;
    atoms[NS_ATOM_dns].name              = "dns";            atoms[NS_ATOM_dns].len = 3;
    atoms[NS_ATOM_driver].name           = "driver";         atoms[NS_ATOM_driver].len = 6;
    atoms[NS_ATOM_e].name                = "e";              atoms[NS_ATOM_e].len = 1;
    atoms[NS_ATOM_ec].name               = "ec";             atoms[NS_ATOM_ec].len = 2;
    atoms[NS_ATOM_ed25519].name          = "ed25519";        atoms[NS_ATOM_ed25519].len = 7;
    atoms[NS_ATOM_ed448].name            = "ed448";          atoms[NS_ATOM_ed448].len = 5;
    atoms[NS_ATOM_email].name            = "email";          atoms[NS_ATOM_email].len = 5;
    atoms[NS_ATOM_enabled].name          = "enabled";        atoms[NS_ATOM_enabled].len = 7;
    atoms[NS_ATOM_error].name            = "error";          atoms[NS_ATOM_error].len = 5;
    ...
    atoms[NS_ATOM_expires].name          = "expires";        atoms[NS_ATOM_expires].len = 7;
    ...
    atoms[NS_ATOM_filename].name         = "filename";       atoms[NS_ATOM_filename].len = 8;
    ...
    atoms[NS_ATOM_group].name            = "group";          atoms[NS_ATOM_group].len = 5;
    ...
    atoms[NS_ATOM_headersVersionNumber].name = "headersVersionNumber"; atoms[NS_ATOM_headersVersionNumber].len = 20;
    atoms[NS_ATOM_headersVersion].name   = "headersVersion"; atoms[NS_ATOM_headersVersion].len = 14;
    atoms[NS_ATOM_headers].name          = "headers";        atoms[NS_ATOM_headers].len = 7;
    atoms[NS_ATOM_hmac].name             = "hmac";           atoms[NS_ATOM_hmac].len = 4;
    ...
    atoms[NS_ATOM_ip].name               = "ip";             atoms[NS_ATOM_ip].len = 2;
    atoms[NS_ATOM_iso8859_DASH_1].name   = "iso8859-1";      atoms[NS_ATOM_iso8859_DASH_1].len = 9;
    atoms[NS_ATOM_issuer].name           = "issuer";         atoms[NS_ATOM_issuer].len = 6;
    atoms[NS_ATOM_kem].name              = "kem";            atoms[NS_ATOM_kem].len = 3;
    atoms[NS_ATOM_keytypes].name         = "keytypes";       atoms[NS_ATOM_keytypes].len = 8;
    ...
    atoms[NS_ATOM_major].name            = "major";          atoms[NS_ATOM_major].len = 5;
    atoms[NS_ATOM_maxentry].name         = "maxentry";       atoms[NS_ATOM_maxentry].len = 8;
    atoms[NS_ATOM_maxsize].name          = "maxsize";        atoms[NS_ATOM_maxsize].len = 7;
    atoms[NS_ATOM_minor].name            = "minor";          atoms[NS_ATOM_minor].len = 5;
    atoms[NS_ATOM_ml_DASH_dsa].name      = "ml-dsa";         atoms[NS_ATOM_ml_DASH_dsa].len = 6;
    atoms[NS_ATOM_ml_DASH_kem].name      = "ml-kem";         atoms[NS_ATOM_ml_DASH_kem].len = 6;
    atoms[NS_ATOM_module].name           = "module";         atoms[NS_ATOM_module].len = 6;
    atoms[NS_ATOM_n].name                = "n";              atoms[NS_ATOM_n].len = 1;
    atoms[NS_ATOM_name].name             = "name";           atoms[NS_ATOM_name].len = 4;
    atoms[NS_ATOM_notafter].name         = "notafter";       atoms[NS_ATOM_notafter].len = 8;
    atoms[NS_ATOM_notbefore].name        = "notbefore";      atoms[NS_ATOM_notbefore].len = 9;
    ...
    atoms[NS_ATOM_pem].name              = "pem";            atoms[NS_ATOM_pem].len = 3;
    ...
    atoms[NS_ATOM_present].name          = "present";        atoms[NS_ATOM_present].len = 7;
    ...
    atoms[NS_ATOM_rsa].name              = "rsa";            atoms[NS_ATOM_rsa].len = 3;
    atoms[NS_ATOM_running].name          = "running";        atoms[NS_ATOM_running].len = 7;
    atoms[NS_ATOM_runtimeVersionNumber].name = "runtimeVersionNumber"; atoms[NS_ATOM_runtimeVersionNumber].len = 20;
    atoms[NS_ATOM_runtimeVersion].name   = "runtimeVersion"; atoms[NS_ATOM_runtimeVersion].len = 14;
    atoms[NS_ATOM_san].name              = "san";            atoms[NS_ATOM_san].len = 3;
    atoms[NS_ATOM_scrypt].name           = "scrypt";         atoms[NS_ATOM_scrypt].len = 6;
    atoms[NS_ATOM_secret].name           = "secret";         atoms[NS_ATOM_secret].len = 6;
    atoms[NS_ATOM_securityBits].name     = "securityBits";   atoms[NS_ATOM_securityBits].len = 12;
    ...
    atoms[NS_ATOM_serial].name           = "serial";         atoms[NS_ATOM_serial].len = 6;
    ...
    atoms[NS_ATOM_sm2].name              = "sm2";            atoms[NS_ATOM_sm2].len = 3;
    ...
    atoms[NS_ATOM_subject].name          = "subject";        atoms[NS_ATOM_subject].len = 7;
    ...
    atoms[NS_ATOM_timeout].name          = "timeout";        atoms[NS_ATOM_timeout].len = 7;
    ...
    atoms[NS_ATOM_unknown].name          = "unknown";        atoms[NS_ATOM_unknown].len = 7;
    atoms[NS_ATOM_unlimited].name        = "unlimited";      atoms[NS_ATOM_unlimited].len = 9;
    atoms[NS_ATOM_unprocessed].name      = "unprocessed";    atoms[NS_ATOM_unprocessed].len = 11;
    atoms[NS_ATOM_uri].name              = "uri";            atoms[NS_ATOM_uri].len = 3;
    ...
    atoms[NS_ATOM_x].name                = "x";              atoms[NS_ATOM_x].len = 1;
    atoms[NS_ATOM_y].name                = "y";              atoms[NS_ATOM_y].len = 1;
