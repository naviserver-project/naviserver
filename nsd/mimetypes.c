...
static const struct exttype {
    ...
    { ".H266",    "video/H266"},                           /* [RFC-ietf-avtcore-rtp-vvc-18] */
    ...
    { ".fdf",     "application/fdf"},                      /* [ISO-TC_171-SC_2][Betsy_Fanning] */
    ...
    { ".jscalendar+json", "application/jscalendar+json"},  /* [RFC8984] */
...
int
NsTclGuessTypeObjCmd(ClientData UNUSED(clientData), Tcl_Interp *interp, TCL_SIZE_T objc, Tcl_Obj *const* objv)
{
    int         result = TCL_OK;
